  ...
  return (
    <div className="py-16">
        ...
        <div className="w-[70%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 mt-16">
            {/* First Project */}
            <div>
                <Image src="/images/p1.jpg" alt="image" width={800} height={650} className="rounded-lg" />
            ...
            {/* Second Project */}
            <div>
                <Image src="/images/p2.jpg" alt="image" width={800} height={650} className="rounded-lg" />
            ...
            {/* Third Project */}
            <div>
                <Image src="/images/p3.jpg" alt="image" width={800} height={650} className="rounded-lg" />
            ...
            {/* Fourth Project */}
            <div>
                <Image src="/images/p4.jpg" alt="image" width={800} height={650} className="rounded-lg" />
